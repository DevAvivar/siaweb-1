...
@Component({
  selector: 'app-relatorio-motivo-rec',
  templateUrl: './relatorio-motivo-rec.component.html',
  styleUrls: ['./relatorio-motivo-rec.component.scss']
})
export class RelatorioMotivoRecComponent implements OnInit {

  nameContent: string = 'Relatório de Motivo Reclamado';//my-toolbar

...
@Component({
  selector: 'app-relatorio-sac',
  templateUrl: './relatorio-sac.component.html',
  styleUrls: ['./relatorio-sac.component.scss']
})
export class RelatorioSacComponent implements OnInit {
  
  nameContent: string = 'Relatório de Serviços de Atendimento ao Consumidor(SAC)';//my-toolbar

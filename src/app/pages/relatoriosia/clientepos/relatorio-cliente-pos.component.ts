...
@Component({
  selector: 'app-relatorio-cliente-pos',
  templateUrl: './relatorio-cliente-pos.component.html',
  styleUrls: ['./relatorio-cliente-pos.component.scss']
})
export class RelatorioClientePosComponent implements OnInit {

  nameContent: string = 'Relatório de Clientes Possíveis Pos-Venda';//my-toolbar

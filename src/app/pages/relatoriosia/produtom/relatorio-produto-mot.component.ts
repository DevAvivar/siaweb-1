...
@Component({
  selector: 'app-relatorio-produto-mot',
  templateUrl: './relatorio-produto-mot.component.html',
  styleUrls: ['./relatorio-produto-mot.component.scss']
})
export class RelatorioProdutoMotComponent implements OnInit {

  nameContent: string = 'Relatório de Produto por Motivo';//my-toolbar
  sac$!: Observable<Sac[]>;
  inactive = false;
  sac!: Observable<Sac>;

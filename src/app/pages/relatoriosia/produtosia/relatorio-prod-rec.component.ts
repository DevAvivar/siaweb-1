...
@Component({
  selector: 'app-relatorio-prod-rec',
  templateUrl: './relatorio-prod-rec.component.html',
  styleUrls: ['./relatorio-prod-rec.component.scss']
})
export class RelatorioProdRecComponent implements OnInit {

  nameContent: string = 'Relatório de Produto Reclamado';//my-toolbar

...
@Component({
  selector: 'app-descargade-materia-prima',
  templateUrl: './descargade-materia-prima.component.html',
  styleUrls: ['./descargade-materia-prima.component.scss']
})
export class DescargadeMateriaPrimaComponent implements OnInit {

  nameContent: string = 'Descarga de Matéria Prima ';//my-toolbar
...
clientReturnDateTime: string = '';
   ...
   */
  displayedColumns: string[] = ['code', 'nameveiculo','lastSectorSent', 'nameClient', 'clientContactDateView', 'statusColumnTable'];//nome da coluna do json que será percorrido
  dataSource: any;//o conteudo da requisição com o Json do objeto retornado na consulta ao backend
  displayHeaderColumns: string[] = ['CODIGO', 'VEICULO','MOTORISTA', 'PRODUTO', 'CHEGADA', 'NIVEL'];//nome da coluna que será exibido no html usado como rotulo

...
@Component({
  selector: 'app-precopor-imp',
  templateUrl: './precopor-imp.component.html',
  styleUrls: ['./precopor-imp.component.scss']
})
export class PrecoporImpComponent implements OnInit {
  nameContent: string = ' Tabela de Preço Por Impressão';//my-toolbar
  ...
  sac!: Observable<Sac>;
     ...
     /*Colocando os dados para controlar os elementos html do template*/
      ...
      displayHeaderColumns: string[] = ['CODIGO', 'VALOR', 'TIPO', 'DATA DE CRIAÇÃO', 'USUARIO CRIADOR'];//nome da coluna que será exibido no html usado como rotulo

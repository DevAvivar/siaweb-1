...
@Component({
  selector: 'app-aluguel-impressora',
  templateUrl: './aluguel-impressora.component.html',
  styleUrls: ['./aluguel-impressora.component.scss']
})
export class AluguelImpressoraComponent implements OnInit {

  nameContent: string = 'Pesquisa de Aluguel de Impressora';//my-toolbar

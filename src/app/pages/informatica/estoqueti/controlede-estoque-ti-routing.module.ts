...
const routes: Routes = [
  {path:'',component:ControledeEstoqueTiComponent}
];
...
export class ControledeEstoqueTiRoutingModule { nameContent: string = 'Cadastro de Solicitação de Novos Produtos';//my-toolbar
...
getRouterCreate(event: any) {
    this.create = event;
    this.router.navigateByUrl("/ped/cadastro");
}

...
@Component({
  selector: 'app-contador-imp',
  templateUrl: './contador-imp.component.html',
  styleUrls: ['./contador-imp.component.scss']
})
export class ContadorImpComponent implements OnInit {

  nameContent: string = ' Contagem de Impressora';//my-toolbar
  ...
  sac!: Observable<Sac>;
     ...
     /*Colocando os dados para controlar os elementos html do template*/
      ...
      /*
       Colocando os dados para receber os inputs properties - FALTA CORRIGIR OS CODIGOS
       */
      displayedColumns: string[] = ['code', 'lastSectorSent', 'nameClient', 'clientContactDateView', 'statusColumnTable', 'statusColumnTable', 'status'];//nome da coluna do json que será percorrido
      dataSource: any;//o conteudo da requisição com o Json do objeto retornado na consulta ao backend
      displayHeaderColumns: string[] = ['CODIGO da IMPRESSORA', 'MODELO DA IMPRESSORA', 'IP', 'SERIE', 'DATA/HORA','TIPO DE IMPRESSÃO', 'CONTAGEM'];//nome da coluna que será exibido no html usado como rotulo
...
pesquisar() { /* TODO document why this method 'print' is empty */ }

incluir() { /* TODO document why this method 'limpar' is empty */ }

remove() { /* TODO document why this method 'print' is empty */ }
vizualizar() { /* TODO document why this method 'limpar' is empty */ }

...
@Component({
  selector: 'app-despesas-impressora',
  templateUrl: './despesas-impressora.component.html',
  styleUrls: ['./despesas-impressora.component.scss']
})
export class DespesasImpressoraComponent implements OnInit {

  nameContent: string = ' Pesquisa de Despesas por Impressora';//my-toolbar
  ...
  displayHeaderColumns: string[] = ['CODIGO', 'IMPRESSORA', 'DATA', 'VALOR', 'DESCRIÇÃO'];//nome da coluna que será exibido no html usado como rotulo

...
import { RelatorioClienteInatComponent } from '../../relatoriosia/clienteinat/relatorio-cliente-inat.component';
...
@Component({
  selector: 'app-emprestimo-equipamento',
  templateUrl: './emprestimo-equipamento.component.html',
  styleUrls: ['./emprestimo-equipamento.component.scss']
})
export class EmprestimoEquipamentoComponent implements OnInit {

  nameContent = 'Pesquisa de Empréstimo de Equipamentos de Informática ';
  sac$!: Observable<Sac[]>;
  inactive = false;
  sac!: Observable<Sac>;
 ...
 */
displayedColumns: string[] = ['code', 'lastSectorSent', 'nameClient', 'clientContactDateView','teste', 'statusColumnTable'];//nome da coluna do json que será percorrido
dataSource: any;//o conteudo da requisição com o Json do objeto retornado na consulta ao backend
displayHeaderColumns: string[] = ['CODIGO', 'EQUIPAMENTO', 'SOLICITANTE', 'RETIRADA', 'DEVOLUÇÃO','STATUS'];//nome da coluna que será exibido no html usado como rotulo
...
incluir() { /* TODO document why this method 'limpar' is empty */ }

Alterar() { /* TODO document why this method 'print' is empty */ }
remove() { /* TODO document why this method 'limpar' is empty */ }

limpar() { /* TODO document why this method 'limpar' is empty */ }

Visualizar() { /* TODO document why this method 'limpar' is empty */ }

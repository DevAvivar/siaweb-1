...
@Component({
  selector: 'app-rotinade-manutencao',
  templateUrl: './rotinade-manutencao.component.html',
  styleUrls: ['./rotinade-manutencao.component.scss']
})
export class RotinadeManutencaoComponent implements OnInit {

  nameContent: string = 'Rotina de Manutenção ';//my-toolbar
   ...
   */
  displayedColumns: string[] = ['code', 'lastSectorSent', 'nameClient', 'clientContactDateView'];//nome da coluna do json que será percorrido
  dataSource: any;//o conteudo da requisição com o Json do objeto retornado na consulta ao backend
  displayHeaderColumns: string[] = ['CODIGO', 'EQUIPAMENTO', 'PARTE DE EQUIPAMENTO', 'TAREFA'];//nome da coluna que será exibido no html usado como rotulo

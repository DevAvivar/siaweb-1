...
@Component({
  selector: 'app-periodicidade-planode-manutencao',
  templateUrl: './periodicidade-planode-manutencao.component.html',
  styleUrls: ['./periodicidade-planode-manutencao.component.scss']
})
export class PeriodicidadePlanodeManutencaoComponent implements OnInit {

  nameContent: string = 'Periodicidade do Plano de Manutenção ';//my-toolbar
  ...
  displayHeaderColumns: string[] = ['CODIGO', 'SOLICITANTE', 'RETIRADA', 'DEVOLUÇÃO', 'STATUS'];//nome da coluna que será exibido no html usado como rotulo

...
@Component({
  selector: 'app-manut-hodom-horimetro',
  templateUrl: './manut-hodom-horimetro.component.html',
  styleUrls: ['./manut-hodom-horimetro.component.scss']
})
export class ManutHodomHorimetroComponent implements OnInit {

  nameContent: string = 'Manutenção Hodômetro /Horímetro ';//my-toolbar
  ...
  displayHeaderColumns: string[] = ['CODIGO', 'EQUIPAMENTO', 'DATA/HORA', 'VALOR'];//nome da coluna que será exibido no html usado como rotulo

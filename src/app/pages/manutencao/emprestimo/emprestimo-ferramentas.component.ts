...
@Component({
  selector: 'app-emprestimo-ferramentas',
  templateUrl: './emprestimo-ferramentas.component.html',
  styleUrls: ['./emprestimo-ferramentas.component.scss']
})
export class EmprestimoFerramentasComponent implements OnInit {

  nameContent: string = 'Empréstimo de Ferramentas ';//my-toolbar

...
@Component({
  selector: 'app-planode-manutencao',
  templateUrl: './planode-manutencao.component.html',
  styleUrls: ['./planode-manutencao.component.scss']
})
export class PlanodeManutencaoComponent implements OnInit {

  nameContent: string = 'Plano de Manutenção ';//my-toolbar
   ...
   */
  displayedColumns: string[] = ['code', 'lastSectorSent', 'nameClient'];//nome da coluna do json que será percorrido
  dataSource: any;//o conteudo da requisição com o Json do objeto retornado na consulta ao backend
  displayHeaderColumns: string[] = ['CODIGO', 'NOME', 'SETOR EXECUTOR'];//nome da coluna que será exibido no html usado como rotulo

...
@Component({
  selector: 'app-gerar-os-planode-manutencao',
  templateUrl: './gerar-os-planode-manutencao.component.html',
  styleUrls: ['./gerar-os-planode-manutencao.component.scss']
})
export class GerarOsPlanodeManutencaoComponent implements OnInit {

  nameContent: string = 'Gerar OS do Plano de Manutenção ';//my-toolbar
  ...
  displayHeaderColumns: string[] = ['CODIGO', 'EQUIPAMENTO', 'PLANO DE MANUTENÇÃO', 'SETOR', 'STATUS'];//nome da coluna que será exibido no html usado como rotulo

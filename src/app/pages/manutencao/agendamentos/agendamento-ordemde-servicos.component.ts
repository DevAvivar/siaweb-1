...
@Component({
  selector: 'app-agendamento-ordemde-servicos',
  templateUrl: './agendamento-ordemde-servicos.component.html',
  styleUrls: ['./agendamento-ordemde-servicos.component.scss']
})
export class AgendamentoOrdemdeServicosComponent implements OnInit {

  nameContent: string = 'Agendamento de Ordem de Serviço';//my-toolbar

...
@Component({
  ...
  templateUrl: './solicitacao-servico.component.html',
  styleUrls: ['./solicitacao-servico.component.scss']
})
export class SolicitacaoServicoComponent implements OnInit {

  nameContent: string = 'Solicitação de Serviços ';//my-toolbar
   ...
   */
  displayedColumns: string[] = ['code', 'lastSectorSent', 'nameClient', 'clientContactDateView','status'];//nome da coluna do json que será percorrido
  dataSource: any;//o conteudo da requisição com o Json do objeto retornado na consulta ao backend
  displayHeaderColumns: string[] = ['CODIGO', 'EQUIPAMENTO', 'TAREFA', 'DATA/HORA','O.S'];//nome da coluna que será exibido no html usado como rotulo

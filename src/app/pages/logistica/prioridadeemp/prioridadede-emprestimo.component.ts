...
@Component({
  selector: 'app-prioridadede-emprestimo',
  templateUrl: './prioridadede-emprestimo.component.html',
  styleUrls: ['./prioridadede-emprestimo.component.scss']
})
export class PrioridadedeEmprestimoComponent implements OnInit {

  nameContent: string = 'Prioridade de Veículo pra Emprestimo ';//my-toolbar
  ...
  displayHeaderColumns: string[] = ['CODIGO', 'PLACA', 'MODELO', 'PRIORIDADE', 'STATUS'];//nome da coluna que será exibido no html usado como rotulo

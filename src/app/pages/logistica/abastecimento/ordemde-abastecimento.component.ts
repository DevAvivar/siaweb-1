...
@Component({
  selector: 'app-ordemde-abastecimento',
  templateUrl: './ordemde-abastecimento.component.html',
  styleUrls: ['./ordemde-abastecimento.component.scss']
})
export class OrdemdeAbastecimentoComponent implements OnInit {

  nameContent: string = 'Ordem de Abastecimento de Veículo';//my-toolbar

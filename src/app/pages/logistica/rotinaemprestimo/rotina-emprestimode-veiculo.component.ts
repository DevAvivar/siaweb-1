...
@Component({
  selector: 'app-rotina-emprestimode-veiculo',
  templateUrl: './rotina-emprestimode-veiculo.component.html',
  styleUrls: ['./rotina-emprestimode-veiculo.component.scss']
})
export class RotinaEmprestimodeVeiculoComponent implements OnInit {

  nameContent: string = 'Emprestimo de Veículo ';//my-toolbar
...
clientReturnDateTime: string = '';
   ...
   */
  displayedColumns: string[] = ['code', 'nameveiculo','lastSectorSent', 'nameClient', 'clientContactDateView','prodDevol', 'statusColumnTable'];//nome da coluna do json que será percorrido
  dataSource: any;//o conteudo da requisição com o Json do objeto retornado na consulta ao backend
  displayHeaderColumns: string[] = ['CODIGO', 'VEICULO','SOLICITANTE', 'RETIRADA', 'DEVOLUÇÃO','DESTINO', 'STATUS'];//nome da coluna que será exibido no html usado como rotulo

...
@Component({
  selector: 'app-emprestimode-veiculo',
  templateUrl: './emprestimode-veiculo.component.html',
  styleUrls: ['./emprestimode-veiculo.component.scss']
})
export class EmprestimodeVeiculoComponent implements OnInit {

...
@Component({
  selector: 'app-aprovador-financeiro',
  templateUrl: './aprovador-financeiro.component.html',
  styleUrls: ['./aprovador-financeiro.component.scss']
})
export class AprovadorFinanceiroComponent {
  nameContent: string = 'APROVADOR FINANCEIRO ';//my-toolbar

...
@Component({
  selector: 'app-pesquisa-adiantamento',
  templateUrl: './pesquisa-adiantamento.component.html',
  styleUrls: ['./pesquisa-adiantamento.component.scss']
})
export class PesquisaAdiantamentoComponent {
  nameContent: string = 'Pesquisa de Adiantamento';//my-toolbar
  ...
  displayHeaderColumns: string[] = ['CODIGO', 'SOLICITANTE', 'DATA DO GASTO', 'VALOR', 'STATUS'];//nome da coluna que será exibido no html usado como rotulo

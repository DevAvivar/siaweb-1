...
@Component({
  selector: 'app-cadastro-mecanico',
  templateUrl: './cadastro-mecanico.component.html',
  styleUrls: ['./cadastro-mecanico.component.scss']
})
export class CadastroMecanicoComponent implements OnInit {

  nameContent: string = 'Cadastro de Mecânico ';//my-toolbar
  ...
  displayHeaderColumns: string[] = ['CODIGO', 'NOME', 'APELIDO', 'FUNÇÃO'];//nome da coluna que será exibido no html usado como rotulo

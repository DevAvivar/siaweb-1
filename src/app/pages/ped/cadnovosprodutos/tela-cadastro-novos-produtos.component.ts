...
import { ProdutoSacmodComponent } from './../../../_shared/produto-sacmod/produto-sacmod.component';
...
@Component({
  selector: 'app-tela-cadastro-novos-produtos',
  templateUrl: './tela-cadastro-novos-produtos.component.html',
  styleUrls: ['./tela-cadastro-novos-produtos.component.scss']
})
export class TelaCadastroNovosProdutosComponent implements OnInit {

  nameContent: string = 'Tela de Cadastro de Novos Produtos';//my-toolbar
 ...
 */
  ...
  /*
     Colocando os dados para receber os inputs properties produto Solicitação
     */
  displayedColumnsPr: string[] = ['nameProduct', 'quantityComplaint', 'nameReasonComplaint'];//nome da coluna do json que será percorrido
  dataSourcePr: any;//o conteudo da requisição com o Json do objeto retornado na consulta ao backend
  displayHeaderColumnsPr: string[] = ['NOME', 'DATA ANEXO', 'FORMATO'];//nome da coluna que será exibido no html usado como rotulo
  ...
  */
  ...
  /*Colocando os dados para receber os inputs properties- Auditoria
 */
